...
class BEntrenador(
    ...
    //cualquier clase que se quiera hay que hacerle parcelable
    //se esta dando una forma para que cualquier otra aplicacion puede entender los datos de esta clase
